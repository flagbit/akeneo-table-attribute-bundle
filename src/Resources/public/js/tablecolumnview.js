define(
    ...
    function ($, _, Backbone, __, Routing, mediator, LoadingMask, Dialog, JsonGenerator) {
        ...
        var EditableItemView = Backbone.View.extend(
            ...
            events: {
                ...
                render: function () {
                    ...
                    this.$el.find('.json-generator').each(
                        function () {
                ...
                loadModelFromView: function () {
                    ...
                    _.each(
                        this.$el.find('.attribute-option-value'), function (input) {
        ...
        var ItemCollectionView = Backbone.View.extend(
            ...
            events: {
                ...
                render: function () {
                    ...
                    _.each(
                        this.collection.models, function (attributeOptionItem) {
        ...
        return function ($element) {
            ...
            mediator.on(
                'attribute:auto_option_sorting:changed', function (autoSorting) {
